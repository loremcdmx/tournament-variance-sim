...
const classic: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(148,163,184,0.52)", width: 1.05, dash: [2, 6] },
  bandWide: { stroke: "rgba(96,165,250,0.7)", width: 1.15, dash: [6, 4] },
  bandNarrow: { stroke: "rgba(125,211,252,0.92)", width: 1.3 },
...
const mono: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(148,163,184,0.56)", width: 1.05, dash: [2, 6] },
  bandWide: { stroke: "rgba(148,163,184,0.78)", width: 1.15, dash: [6, 4] },
  bandNarrow: { stroke: "rgba(226,232,240,0.94)", width: 1.3 },
...
const highContrast: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(148,163,184,0.56)", width: 1.1, dash: [2, 6] },
  bandWide: { stroke: "rgba(86,180,233,0.84)", width: 1.2, dash: [6, 4] },
  bandNarrow: { stroke: "rgba(240,249,255,0.98)", width: 1.35 },
...
const neon: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(148,163,184,0.52)", width: 1.05, dash: [2, 6] },
  bandWide: { stroke: "rgba(96,165,250,0.74)", width: 1.15, dash: [6, 4] },
  bandNarrow: { stroke: "rgba(125,211,252,0.94)", width: 1.3 },
