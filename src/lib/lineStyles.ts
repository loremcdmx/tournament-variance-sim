...
const classic: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(251,191,36,0.14)", width: 1, dash: [2, 5] },
...
const duotone: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(45,212,191,0.14)", width: 1, dash: [2, 5] },
...
const mono: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(148,163,184,0.14)", width: 1, dash: [2, 5] },
...
const vivid: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(192,132,252,0.14)", width: 1, dash: [2, 5] },
...
const highContrast: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(230,159,0,0.14)", width: 1, dash: [2, 5] },
...
const neon: LineStylePreset = {
  ...
  bandWide: { stroke: "rgba(0,255,136,0.14)", width: 1, dash: [2, 5] },
...
export const PRIMEDOPE_PANE_PRESET: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(96,165,250,0.10)", width: 1 },
  bandWide: { stroke: "rgba(96,165,250,0.20)", width: 1, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(96,165,250,0.38)", width: 1 },
  refLine: { stroke: "#64748b", width: 1, dash: [3, 4] },
  bankrollLine: { stroke: "#ef4444", width: 1.5 },
};
