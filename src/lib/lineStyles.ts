...
const classic: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(251,191,36,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(251,191,36,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(251,191,36,0.36)", width: 1.2 },
...
const duotone: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(45,212,191,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(45,212,191,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(45,212,191,0.36)", width: 1.2 },
  refLine: { stroke: "#64748b", width: 1, dash: [3, 4] },
  bankrollLine: { stroke: "#ef4444", width: 1.5 },
};
...
const mono: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(148,163,184,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(148,163,184,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(148,163,184,0.34)", width: 1.2 },
...
const vivid: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(192,132,252,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(192,132,252,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(192,132,252,0.36)", width: 1.2 },
  refLine: { stroke: "#64748b", width: 1, dash: [3, 4] },
  bankrollLine: { stroke: "#ef4444", width: 1.5 },
};
...
const highContrast: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(230,159,0,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(230,159,0,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(230,159,0,0.36)", width: 1.2 },
...
const neon: LineStylePreset = {
  ...
  bandExtreme: { stroke: "rgba(0,255,136,0.09)", width: 1.1 },
  bandWide: { stroke: "rgba(0,255,136,0.20)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(0,255,136,0.36)", width: 1.2 },
...
export const PRIMEDOPE_PANE_PRESET: LineStylePreset = {
  ...
  p95: { stroke: "#60a5fa", width: 1.75 },
  path: { stroke: "rgba(96,165,250,0.24)", width: 1 },
  bandExtreme: { stroke: "rgba(96,165,250,0.13)", width: 1.1 },
  bandWide: { stroke: "rgba(96,165,250,0.26)", width: 1.15, dash: [2, 5] },
  bandNarrow: { stroke: "rgba(96,165,250,0.46)", width: 1.2 },
  refLine: { stroke: "#64748b", width: 1, dash: [3, 4] },
  bankrollLine: { stroke: "#ef4444", width: 1.5 },
};
