...
export const SCENARIOS: DemoScenario[] = [
  ...
  {
    id: "mixed-daily-all-formats",
    labelKey: "demo.mixedDailyAllFormats",
    description:
      "Ежедневный микс $11-$55: фризы, PKO и Mystery на средних полях. Хороший пресет для blended-гринда без экзотики и без вырожденных строк.",
    schedule: [
      {
        id: "daily-fr11",
        label: "GG $11 freeze",
  ...
  {
    id: "mixed-gg-with-br",
    labelKey: "demo.mixedGgWithBr",
    description:
      "GG-only микс с Battle Royale, Mystery и PKO. Показывает, как BR-поинты, envelope-tail и обычный bounty-channel живут в одном расписании.",
    schedule: [
      {
        id: "gg-br3",
        label: "GG Battle Royale $3",
  ...
  {
    id: "mixed-sunday-majors",
    labelKey: "demo.mixedSundayMajors",
    description:
      "Воскресный микс мейджоров: большие фризы, PKO и Mystery в одном банкролле. Полезен для оценки blended-variance на дорогих воскресных сессиях.",
    schedule: [
      {
        id: "sun-fr109",
        label: "PS Sunday $109",
