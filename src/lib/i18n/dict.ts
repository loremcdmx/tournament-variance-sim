...
export const DICT = {
  ...
  "chart.convergence.bandWarning.mystery": {
    en: "For Mystery the closed-form σ approximation still leaves a wide tail (LOO p95 ≈ 17 %) so the ± band isn't shown. Use the number as a ballpark — lean on a full run for the real answer. PKO / Freeze / Battle Royale band honestly inside their validated training boxes.",
    ru: "Для Мистери быстрая σ-аппроксимация оставляет широкий хвост (LOO p95 ≈ 17 %), поэтому ±-полоса пока не рисуется. Считай цифру ориентиром — настоящий ответ даёт полный прогон. ПКО / Фриз / Батл Рояль рисуют полосу честно только в пределах validated training box.",
  },
