...
export const DICT = {
  ...
  "chart.convergence.bandWarning.pkoMystery": {
    en: "The 200k PKO / Mystery sweep says this closed-form σ is still too rough for a numeric range. Keep the point as a ballpark; use a full simulation run for the real answer.",
    ru: "200k-свип ПКО / Мистери показал, что эта closed-form σ всё ещё слишком грубая для числового диапазона. Точку можно читать как ориентир; настоящий ответ даёт полный симуляционный прогон.",
  },
