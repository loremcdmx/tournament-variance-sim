...
// histogramOf + poissonPTRS keep their old import path (`./engine`) for the
// trajectory transforms and tests that already depend on it.
export { histogramOf, poissonPTRS };
