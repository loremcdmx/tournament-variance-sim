...
- **Tailwind 4**
- **Vitest** — 400+ тестов на движке и UI-математике: determinism, realized-ROI-in-SE, progress lifecycle, rakeback/path transforms, row decomposition sums, re-entry variance amplification, ICM flattening, empirical histogram reproduction и т.д.
